...
namespace IntegratedCourseSystem.IntegrationTests
{
    public class UserIntegrationTests : IntegrationTestBase
    {
        ...
        //[Fact]
        //public async Task LogOut_ShouldReturnEmptyStringAndLogOut()
        //{
        //    // Arrange
        ...
        //    var response = client.SendAsync(request).Result;
        //    var content = await response.Content.ReadAsStringAsync();
        //    var responseAfterLogout = client.PostAsync(baseAddress + "/api/users/logged_in", null).Result;
        //    var contentOfAfterLogout = await responseAfterLogout.Content.ReadAsStringAsync();
        //    // Assert
        //    response.EnsureSuccessStatusCode();
        //    responseAfterLogout.EnsureSuccessStatusCode();
        //    Assert.Equal("", content);
        //    Assert.Equal("", contentOfAfterLogout);
        //}
        ...
        public async Task Register_ShouldReturnCreatedAtAction()
        {
            ...
            var newUser = new DataBase.Models.User()
            {
                ...
                Student = dbContext.Students.Find(2)
            };
